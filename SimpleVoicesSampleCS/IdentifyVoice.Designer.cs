namespace Neurotec.Samples
{
	partial class IdentifyVoice
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnOpenTemplates.Click += new System.EventHandler(this.BtnOpenTemplatesClickAsync);
			// 
			// matchingGroupBox
			// 
			...
			this.btnOpenAudio.Click += new System.EventHandler(this.BtnOpenAudioFileClickAsync);
			// 
			// listView
			// 
			...
			this.btnIdentify.Click += new System.EventHandler(this.BtnIdentifyClickAsync);
			// 
			// licensePanel
			// 
