namespace Neurotec.Samples
{
	partial class VerifyVoice
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnVerify.Click += new System.EventHandler(this.BtnVerifyClickAsync);
			// 
			// label1
			// 
			...
			this.btnOpen1.Click += new System.EventHandler(this.BtnOpen1ClickAsync);
			// 
			// btnOpen2
			// 
			...
			this.btnOpen2.Click += new System.EventHandler(this.BtnOpen2ClickAsync);
			// 
			// gbMatching
			// 
