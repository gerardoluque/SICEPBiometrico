namespace Neurotec.Samples
{
	partial class EnrollFromFile
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnExtract.Click += new System.EventHandler(this.BtnExtractClickAsync);
			// 
			// nudPhraseId
			// 
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.extractFeatures);
			...
			this.extractFeatures.Location = new System.Drawing.Point(6, 19);
			this.extractFeatures.Name = "extractFeatures";
			this.extractFeatures.Size = new System.Drawing.Size(196, 21);
			this.extractFeatures.TabIndex = 20;
			this.extractFeatures.SelectedIndexChanged += new System.EventHandler(this.ExtractFeaturesSelectedIndexChanged);
			// 
			// lblStatus
			// 
