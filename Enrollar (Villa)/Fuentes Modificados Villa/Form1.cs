...
namespace Enrolar
{
    public partial class Form1 : Form
    {
        ...
        public void RegistraHuella(int dedo, byte[] imageData, byte[] templete, byte[] wsq)
        {
            ...
            string insert = " INSERT INTO BTS.HUELLA(ESTADO, MUNICIPIO, CERESO, ANO, FOLIO, DEDO, HUELLAIMAGEN, TEMPLATE, WSQ) VALUES (" + param[4] + "," + param[5] + ",'" + param[6] + "'," + param[7] + "," + param[8] + "," + dedo.ToString() + ", :BlobParameter, :BlobParameter2, :BlobParameter3 )";
